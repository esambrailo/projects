...
# MAGIC %md
# MAGIC
# MAGIC # Random Forest Model - Final Pure Validation Selection
# MAGIC
# MAGIC This notebook is running pure validation on the final selected Random Forest model.
# MAGIC Creating an ensemble of various random forests of various timeframes was explored to see if that would help capture importances from high and low frequency features, but the benefits of doing did not improve upon a single train of the entire train dataset.  For that reason, we are continuing with just that logic. 
# MAGIC
...
pure_val_train = 'ES/RF/Model4_final_train'
# directory for test results
pure_val_val = 'ES/RF/Model4_final_val'
...
CutOffs = [percentage/100 for percentage in range(40, 51, 1)]
print(CutOffs)
